  ...
  class CardAPI < SparrowOne::API
    ...
    def sale(params)
      with_error_handling do
        validate(params, requires: [:cardnum, :cardexp, :amount])
        post("sale", params)
      end
    end
    ...
    def auth(params)
      with_error_handling do
        validate(params, requires: [:cardnum, :amount, :cardexp])
        post("auth", params)
      end
    end
    ...
    def capture(params)
      with_error_handling do
        validate(params, requires: [:transid, :amount])
        post("capture", params)
      end
    end
    ...
    def offline(params)
      with_error_handling do
        validate(params, requires: [:cardnum, :cardexp, :amount, :authcode, :authdate])
        post("offline", params)
      end
    end
    ...
    def passenger_sale(params)
      with_error_handling do
        validate(params, requires: [:cardnum, :amount, :cardexp, :passengername,
    ...
    def balance(params)
      with_error_handling do
        validate(params, requires: [:cardnum])
    ...
    def verify(params)
      with_error_handling do
        validate(params, requires: [:cardnum, :cardexp])
